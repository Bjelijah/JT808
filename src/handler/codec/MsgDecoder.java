...
//		ret.setCheckSum(checkSumInPkg);
		if (checkSumInPkg != calculatedCheckSum) {
			System.err.println("检验码不一致,msgid:{},pkg:{},calculated:{}"+ msgHeader.getMsgId()+ "  " +checkSumInPkg+"   " +calculatedCheckSum);
		}else{
			System.out.println("验证码一致："+checkSumInPkg);
		}
		return ret;
	}
